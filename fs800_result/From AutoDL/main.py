...
# build dataset
train_dataset = FeatureDataset(root_path = '/root/autodl-tmp/FS1000 Dataset/', is_train = True)
val_dataset = FeatureDataset(root_path = '/root/autodl-tmp/FS1000 Dataset/', is_train = False)
