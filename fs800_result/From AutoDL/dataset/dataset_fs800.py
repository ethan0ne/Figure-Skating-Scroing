...
class FeatureDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        audio_path = "/root/autodl-tmp/FS1000 Dataset/ast_feature_fs1000/" + data_index + '.npy'
        video_path = "/root/autodl-tmp/FS1000 Dataset/c3d_feature_fs1000/" + data_index + '.npy'
